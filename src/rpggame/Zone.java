...
import rpggame.MapGenerator.World;
...
public class Zone {
	...
	ArrayList<Zone> zonesInWorld = new ArrayList<>();
	 ...
	 */
	public Zone(String name, ArrayList<Zone> zonesInWorld, World world) {
		this.name = name;
	...
	public void addHouseTile(IntegerPair ip, String name) {
		...
		Zone houseZone = new Zone("House", houseWorld.zones, houseWorld);
		...
		MapGenerator.worlds.add(houseWorld);
	...
	public void generateCave() {
		...
		Zone caveZone = new Zone(this.name, caveWorld.zones, caveWorld);
	 ...
	 */
	private static boolean overlapsInclusive(Rectangle rectangle, Zone zone) {
	 ...
	 * @return true if overlap, false otherwise.
	 */
	private static boolean overlapsExclusive(Rectangle rectangle, Zone zone) {
